...
[![Latest Stable Version](http://img.shields.io/packagist/v/swoft/elasticsearch.svg)](https://packagist.org/packages/swoft/elasticsearch)
...
```bash
composer require swoft/elasticsearch
```
